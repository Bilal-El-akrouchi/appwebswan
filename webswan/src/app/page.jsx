    ...
    <>
      ...
      <div id="home">
        <section className={`${bg} overflow-hidden w-full`}>
          ...
          ></div>
          <div
            className={`m-30 absolute z-10 ${
              forfait == 0 ? "opacity-100" : "opacity-0"
            }`}
          >
          ...
          <div
            className={`m-30 absolute z-10 transition ${
              forfait == 1 ? "opacity-100" : "opacity-0"
            }`}
          >
          ...
          <div
            className={`m-30 absolute z-10 transition ${
              forfait == 2 ? "opacity-100" : "opacity-0"
            }`}
          >
          ...
          <div
            className={`m-30 absolute z-10 transition ${
              forfait == 3 ? "opacity-100" : "opacity-0"
            }`}
          >
          ...
          <div
            className={`m-30 absolute z-10 transition ${
              forfait == 4 ? "opacity-100" : "opacity-0"
            }`}
          >
          ...
          <div className="h-screen ml-50 w-full flex gap-2 items-end justify-end">
            {items.map((item, index) => (
              <div
                ...
                key={index}
                className={`h-[50%] w-55 rounded-xl z-10 transition ${item} ${
                  zoom == index ? "zoom" : ""
                }`}
              ></div>
            ))}
